...
if EnvSplit:
    ...
    for line in lines:
        l = line.split('\t')
        if l[0] in SimInfo:
            if l[-2] == 'Central' and int(l[1]) in SimInfo[l[0]]['goodhalos']:
                cens.append((l[0], l[1]))
            elif l[-2] == 'Satellite' and int(l[1]) in SimInfo[l[0]]['goodhalos']:
                sats.append((l[0], l[1]))
            elif l[-2] == 'Backsplash' and int(l[1]) in SimInfo[l[0]]['goodhalos']:
                cens.append((l[0], l[1]))
